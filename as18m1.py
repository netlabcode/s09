...
val1 = client.get_node("ns=2;i=611")
val2 = client.get_node("ns=2;i=612")
val3 = client.get_node("ns=2;i=613")
val4 = client.get_node("ns=2;i=614")
val5 = client.get_node("ns=2;i=615")
val6 = client.get_node("ns=2;i=616")
