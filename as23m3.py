...
val1 = client.get_node("ns=2;i=728")
val2 = client.get_node("ns=2;i=729")
val3 = client.get_node("ns=2;i=730")
val4 = client.get_node("ns=2;i=731")
val5 = client.get_node("ns=2;i=732")
val6 = client.get_node("ns=2;i=733")
val7 = client.get_node("ns=2;i=734")
