...
val1 = client.get_node("ns=2;i=400")
val2 = client.get_node("ns=2;i=401")
val3 = client.get_node("ns=2;i=402")
val4 = client.get_node("ns=2;i=403")
val5 = client.get_node("ns=2;i=404")
val6 = client.get_node("ns=2;i=405")
