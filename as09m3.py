...
val1 = client.get_node("ns=2;i=379")
val2 = client.get_node("ns=2;i=380")
val3 = client.get_node("ns=2;i=381")
val4 = client.get_node("ns=2;i=382")
val5 = client.get_node("ns=2;i=383")
val6 = client.get_node("ns=2;i=384")
